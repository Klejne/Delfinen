...
public class Coach extends User
{
   ...
   public static void printResults()
   {
      ...
      for (String discipline : Result.disciplines)
      {
         ...
         {  
            System.out.printf("%d. | %4d | %-10s | %4.2f s%s", position, bestMember.id, bestMember.name, bestMember.bestTime(discipline) / 1000.0, System.lineSeparator());
            position++;
         }
   ...
   public static void resultsToFile()
   {
      ...
      for (String discipline : Result.disciplines)
      {
         ...
         for (Member bestMember : members)
         {  
            output.printf("%d. | %4d | %-10s | %4.2f s%s", position, bestMember.id, bestMember.name, bestMember.bestTime(discipline) / 1000.0, System.lineSeparator());
            position++;
         }
